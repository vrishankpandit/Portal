...
var TextureNode = class extends UniformNode_default {
  ...
  getDefaultUV() {
    defaultUV || (defaultUV = new UVNode_default());
    return defaultUV;
  }
  construct(builder) {
    const properties = builder.getNodeProperties(this);
...
__publicField(_MathNode, "RECIPROCAL", "reciprocal");
// 2 inputs
...
var _TangentNode = class _TangentNode extends Node_default {
...
__publicField(_TangentNode, "GEOMETRY", "geometry");
__publicField(_TangentNode, "LOCAL", "local");
__publicField(_TangentNode, "VIEW", "view");
__publicField(_TangentNode, "WORLD", "world");
...
var _BitangentNode = class _BitangentNode extends Node_default {
...
__publicField(_BitangentNode, "GEOMETRY", "geometry");
__publicField(_BitangentNode, "LOCAL", "local");
__publicField(_BitangentNode, "VIEW", "view");
__publicField(_BitangentNode, "WORLD", "world");
...
__publicField(_PositionNode, "WORLD_DIRECTION", "worldDirection");
...
var MaxMipLevelNode = class extends UniformNode_default {
  ...
  update() {
    ...
    const image = images && images.length > 0 ? ((_a = images[0]) == null ? void 0 : _a.image) || images[0] : texture2.image;
...
var CubeTextureNode = class extends TextureNode_default {
  ...
  getDefaultUV() {
    defaultUV2 || (defaultUV2 = new ReflectVectorNode_default());
    return defaultUV2;
  }
  generate(builder, output) {
    const { uvNode, levelNode } = builder.getNodeProperties(this);
...
var _BlendModeNode = class _BlendModeNode extends Node_default {
...
__publicField(_BlendModeNode, "BURN", "burn");
__publicField(_BlendModeNode, "DODGE", "dodge");
__publicField(_BlendModeNode, "SCREEN", "screen");
__publicField(_BlendModeNode, "OVERLAY", "overlay");
...
var resolution;
var _ViewportNode = class _ViewportNode extends Node_default {
  constructor(scope) {
    super();
    this.scope = scope;
...
__publicField(_ViewportNode, "COORDINATE", "coordinate");
__publicField(_ViewportNode, "RESOLUTION", "resolution");
__publicField(_ViewportNode, "TOP_LEFT", "topLeft");
__publicField(_ViewportNode, "BOTTOM_LEFT", "bottomLeft");
__publicField(_ViewportNode, "TOP_RIGHT", "topRight");
__publicField(_ViewportNode, "BOTTOM_RIGHT", "bottomRight");
...
__publicField(_TimerNode, "FRAME", "frame");
...
var NodeBuilder = class {
  ...
  hasGeometryAttribute(name) {
    var _a;
    return ((_a = this.geometry) == null ? void 0 : _a.getAttribute(name)) !== void 0;
  }
...
var NodeMaterial = class extends ShaderMaterial {
  ...
  generateOutput(builder, { diffuseColorNode, outgoingLightNode }) {
    ...
    if ((fogNode == null ? void 0 : fogNode.isNode) !== true && builder.scene.fog) {
